...
module.exports = {
  landing: Backbone.View.extend({
    ...
    initialize() {
      ...
      app.helpers.scripts.loadCalendlyAPI().then(() => {
        Calendly.initBadgeWidget({
          url: 'https://calendly.com/johnc-6/15min',
    ...
    destroy() {
      ...
      if (window.Calendly && Calendly.destroyBadgeWiget) {
  ...
  teamMembers: Backbone.View.extend(Object.assign({
    ...
    initDragDrop() {
      this.sortable = Sortable.Sortable.create(document.querySelector('.teamMembersContainer'), {
        animation: 150,
