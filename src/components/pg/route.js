  ...
  methods: {
    ...
    subscriptionThanks() {
      ...
      require.ensure([], (require) => {
        ...
        let text = "Your subscription to the GrowthFountain Newsletter <br> is Confirmed!";
        if (app.getParams().type == "regd") {
          text = "Thank you! We will reach out to you with Reg D offerings"
        }

        app.currentView = new Views.subscriptionThanks({ template, text });
        app.currentView.render();
